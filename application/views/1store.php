...
<head>
	...
	<script src="//cdn.foxycart.com/1store/foxycart.colorbox.js?ver=2" type="text/javascript" charset="utf-8"></script>
	<!-- END FOXYCART FILES -->
</head>
<body>
	...
	<!-- form example -->
	<form action="https://1store.foxycart.com/cart" method="post" accept-charset="utf-8">
